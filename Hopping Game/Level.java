...
public class Level extends World {
    ...
    private ActiverseSound sound1 = new ActiverseSound("spawn.wav"); // Use WAV file
    private ActiverseSound sound2 = new ActiverseSound("theme.wav"); // Use WAV file
    ...
    private void scheduleBrickSpawn() {
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                spawnBrick();
                sound1.play();
                timeToSpawn = Math.max(500, timeToSpawn - 350);
                scheduleBrickSpawn();
            }
        }, timeToSpawn);
    }
